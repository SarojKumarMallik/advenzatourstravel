...
/* HOVER ZOOM */
.pkg-overview-img:hover img{
    transform:scale(1.08);
}

/* OVERLAY */
.pkg-overview-img::after{
    content:"";
    position:absolute;
    inset:0;
...
<section class="pkg-overview-sec">

    <div class="pkg-overview-wrap">
...
<section class="pkg-combo-sec">

    <div class="pkg-combo-wrap">
...
/* DOT POSITION */
.pkg-item.left::before{
    right:-7px;
}
.pkg-item.right::before{
    left:-7px;
}
